...
if (isset($_POST['register'])) {
 ...
 $function = 1;
 if (isset($_POST["register-bedrijf"])) {
  // Execute the code for this button
  $function = 2;
}
      ...
      <body>
        <center>
          ...
          <form action="/profile/register.php" method="post" class="flex flex-col gap-8 w-full md:max-w-2xl">
            ...
            <button name="register" class="btn btn-primary">Register als klant</button>
            <button name="register-bedrijf" class="btn btn-primary">Registreer als bedrijf</button>
          </form>
        </center>
      </body>
      </html>
