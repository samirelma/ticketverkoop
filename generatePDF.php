...
if ($categorie["name"] == "Golden Cirkel (VIP)") {
 $kleineLetters = "Op vertoon van dit ticket krijg je toegang tot het eten, de zaal en de parking. De deuren van de voorstelling gaan telkens een half uur voor de start van de voorstelling open.\n Met dit ticket kan je maar een keer binnen geef deze ticket dus niet door zonder dit te registreren op de website."; 
} else {
